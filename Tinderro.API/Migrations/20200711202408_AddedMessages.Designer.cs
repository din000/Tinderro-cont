...
namespace Tinderro.API.Migrations
{
    ...
    [Migration("20200711202408_AddedMessages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tinderro.API.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Tinderro.API.Models.Message", b =>
                {
                    b.HasOne("Tinderro.API.Models.User", "Recipient")
                        .WithMany("MessagesRecived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Tinderro.API.Models.User", "Sender")
